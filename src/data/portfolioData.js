...
export const projects = [
  {
    ...
    metrics: ["⚡ 40% Reduction in Hallucinations", "🎯 35% Higher Answer Accuracy", "⏱️ 25% Lower Retrieval Latency"],
  ...
  },
  {
    ...
    metrics: ["🛡️ 92% Detection Precision", "⚡ 60% Faster Review Turnaround", "🔍 Zero-Day Pattern Catching"],
    githubUrl: "https://github.com/kodurupakakumaraanurag-png",
    liveUrl: "https://linkedin.com/in/kodurupaka-kumaraanurag-4b450b302",
    featured: true,
    architecture: [
